  ...
  return (
    <section className="bg-base-200 py-16 md:py-20">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        ...
        <motion.div
          className="flex flex-col sm:flex-row justify-center items-center gap-6 sm:gap-10 text-lg" 
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }}
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-base-content/90">
              Pursuing Master’s in Machine Learning at University of North Texas
            </span>
          </div>
